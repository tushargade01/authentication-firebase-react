...
import GithubLogo from "../assets/Github.png"; // ✅ Use ES import in Vite
  ...
  return (
    <div>
      ...
      >
        ...
        <button
          type="submit"
          className="w-[270px] xs:w-[360px] md:w-[450px] bg-purple-700 text-white text-base font-medium md:font-semibold rounded-full mt-5 py-2"
        >
          Submit
        </button>
      </form>
      ...
      <div className="flex flex-col items-center">
        <button
          type="button"
          className="w-[270px] sm:w-[360px] md:w-[450px] bg-gray-100 text-black text-base font-medium rounded-full mt-5 flex items-center justify-center py-2"
          onClick={() => signInWithGoogle()}
        >
          <img
            src="https://cdn-icons-png.flaticon.com/128/2991/2991148.png"
            alt="google"
            className="h-[25px] md:h-[28px] mr-2"
          />
          Login with Google
        </button>
        ...
        <button
          type="button"
          className="w-[270px] sm:w-[360px] md:w-[450px] bg-white border-gray-200 border-2 text-base font-medium rounded-full my-5 flex items-center justify-center py-2"
          onClick={() => signInWithGithub()}
        >
          <img
            src={GithubLogo}
            alt="github"
            className="h-[30px] sm:h-[36px] mr-2"
          />
          Login with Github
        </button>
